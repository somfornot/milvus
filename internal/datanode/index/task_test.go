...
func (manifestPublishingTestIndex) Serialize() ([]*indexcgowrapper.Blob, error) {
	return nil, nil
}
...
func (suite *IndexBuildTaskSuite) TestStorageV3PostExecutePublishesManifestIndex() {
	...
	req := &workerpb.CreateJobRequest{
		...
		FieldID:                   102,
		Field:                     &schemapb.FieldSchema{FieldID: 102, Name: "vec", DataType: schemapb.DataType_FloatVector},
